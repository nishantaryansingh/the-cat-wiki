...
To use or run this project, you must have the following installed on your computer:

### Java (Java Development Kit – JDK)

This project is written in Java, so you must install the Java Development Kit (JDK) on your system. Download and install a JDK from one of the following official sources:
- https://adoptium.net
...
## Troubleshooting
If you cannot run Main.java using your method, the easiest way is to open your computer's command/terminal window and run 

### Windows
```bash
cd The-Cat-Wiki/CodeFiles/scripts && javac Main.java && java Main
```
